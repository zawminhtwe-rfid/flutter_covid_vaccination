...
class QrRDTPage extends StatefulWidget {
  String qrcode;
  QrRDTPage({this.qrcode});
  @override
  _QrRDTPageState createState() => _QrRDTPageState();
}

class _QrRDTPageState extends State<QrRDTPage> {
